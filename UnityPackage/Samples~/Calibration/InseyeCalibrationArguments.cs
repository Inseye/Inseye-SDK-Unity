...
namespace Inseye.Samples.Calibration
{
    public sealed class InseyeCalibrationArguments
    {
        ...
        internal System.Action<InseyeCalibrationResult>? OnCalibrationFinished;
        ...
        /// <summary>
        ///     Adds callback that will be invoked when calibration ends successfully.
        /// </summary>
        /// <returns>Modified calibration arguments.</returns>
        public InseyeCalibrationArguments AddCalibrationSuccessCallback(System.Action callback)
        {
            if (callback is null)
                throw new System.ArgumentNullException(nameof(callback));
            OnCalibrationFinished += args =>
            {
                if (args == InseyeCalibrationResult.Successful)
                    callback();
            };
            return this;
        }
        ...
        /// <summary>
        ///     Adds callback that will be invoked when calibration ends failing.
        ///     <exception cref="System.ArgumentNullException">Thrown when callback is null.</exception>
        /// </summary>
        /// <returns>Modified calibration arguments.</returns>
        public InseyeCalibrationArguments AddCalibrationFailedCallback(System.Action callback)
        {
            if (callback is null)
                throw new System.ArgumentNullException(nameof(callback));
            OnCalibrationFinished += args =>
        ...
        /// </summary>
        /// <returns>Modified calibration arguments.</returns>
        public InseyeCalibrationArguments AddCalibrationFinishedCallback(
            System.Action<InseyeCalibrationResult> callback)
        {
            ...
            Interfaces.ICalibrationProcedure procedure)
        {
            ...
            System.Action<InseyeCalibrationResult> callback = _ => SceneManager.LoadScene(activeSceneBuildIndex);
