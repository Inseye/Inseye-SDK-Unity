...
namespace Inseye.Samples.Calibration
{
    ...
    public sealed class InseyeCalibration : MonoBehaviour
    {
        ...
        private System.Action<InseyeCalibrationResult>? _onCalibrationFinished;
        ...
        public void StartCalibration(Interfaces.ICalibrationProcedure calibrationProcedure,
            System.Action<InseyeCalibrationResult>? onFinishCallback = null)
        {
        ...
        public static async System.Threading.Tasks.Task<InseyeCalibrationResult> PerformCalibrationAsync(InseyeCalibrationArguments arguments,
            System.Threading.CancellationToken token = default)
        {
            token.ThrowIfCancellationRequested();
            var tcs = new TaskCompletionSource<InseyeCalibrationResult>();
            arguments.AddCalibrationFinishedCallback(args => tcs.TrySetResult(args));
        ...
        public static void PerformCalibration(InseyeCalibrationArguments arguments)
        {
            ...
            void ActiveSceneChangedHandler(Scene oldScene, Scene newScene)
            {
                ...
                else
                {
                    ...
                    {
                        arguments.OnCalibrationFinished?.Invoke(InseyeCalibrationResult.MissingCalibrationGameObject);
                    }
                }
        ...
        private IEnumerator CalibrationCoroutine()
        {
            ...
            if (_calibrationProcedure is not null)
            {
                    ...
                    or InseyeCalibrationState.Ongoing)
                {
                    ...
                    catch (SDKCalibrationException exception)
                    {
                        ...
                        InvokeOnCalibrationFinished(InseyeCalibrationResult.FailedToStartCalibration);
                        yield break;
                    }
                }
                else
                {
                    InvokeOnCalibrationFinished(InseyeCalibrationResult.InvalidState);
                    yield break;
                }
            }
            else
            {
                InvokeOnCalibrationFinished(InseyeCalibrationResult.NullCalibrationProcedure);
                yield break;
            }
            ...
            switch (_calibrationProcedure.InseyeCalibrationState)
            {
                case InseyeCalibrationState.FinishedFailed:
                    InvokeOnCalibrationFinished(InseyeCalibrationResult.CalibrationAborted);
                    break;
                case InseyeCalibrationState.FinishedSuccessfully:
                    InvokeOnCalibrationFinished(InseyeCalibrationResult.Successful);
                    break;
        ...
        private void InvokeOnCalibrationFinished(InseyeCalibrationResult calibrationResult)
        {
#if DEBUG_INSEYE_SDK
            Debug.Log($"Calibration finished, status: {calibrationResult:G}");
#endif
            _onCalibrationFinished?.Invoke(calibrationResult);
        }
