...
namespace Inseye
{
    ...
    public static partial class InseyeSDK
    {
        ...
        ///     SDK version.
        /// </summary>
        public static readonly InseyeComponentVersion SDKVersion = new(4, 2, 2);
        ...
        /// <summary>
        ///     Returns true if eye tracker calibration model is available.
        ///     Even if this method true a new calibration may be advised if user experience degrades.
        /// </summary>
        /// <returns>True if user is calibrated otherwise false.</returns>
        [Obsolete(
        ...
        {
            return CurrentImplementation.IsCalibrated();
        }
        ...
        [Obsolete("Will be removed in SDK 5.0.0.")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static void BeginRecordingRawData()
        {
            if (CurrentImplementation is IInternalSDK internalSDK)
            {
                internalSDK.BeginRecordingRawData();
                return;
            }

            throw new SDKInternalException(
                $"Current SDK implementation ({CurrentImplementation.GetType().FullName}) doesn't support internal api.");
        }

        [Obsolete("Will be removed in SDK 5.0.0.")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static string EndRecordingRawData()
        {
            if (CurrentImplementation is IInternalSDK internalSDK)
            {
                return internalSDK.EndRecordingRawData();
            }
